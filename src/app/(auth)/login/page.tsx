        ...
        <div className="w-full max-w-sm animate-fade-in">
          ...
          <form className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  id="email"
                  type="email"
                  defaultValue="admin@masheuri.com"
            ...
            <div className="flex items-center gap-2">
              <input type="checkbox" id="remember" className="w-4 h-4 rounded accent-[#6366f1]" defaultChecked />
              <Label htmlFor="remember" className="text-sm text-gray-500 cursor-pointer">Remember me for 30 days</Label>
            </div>

            <Link href="/dashboard">
              <Button className="w-full h-11 text-sm font-semibold rounded-xl mt-1 group"
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center">
                <span className="px-3 bg-white text-xs text-gray-400">or continue as</span>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-3">
              {["Broker", "Sub-Broker"].map((role) => (
                <Link key={role} href="/dashboard">
                  <Button variant="outline" className="w-full h-10 text-sm rounded-xl border-gray-200 text-gray-500 hover:border-[#6366f1] hover:text-[#6366f1] hover:bg-[#f5f3ff] transition-all">
                    {role}
                  </Button>
                </Link>
              ))}
